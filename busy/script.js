...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table-container { width: 100%; margin: 2px 0 8px; flex-grow: 1; display: flex; flex-direction: column; }
        ...
        @media print {
            ...
            .inner-border { padding: 10px 12px; height: 100%; box-sizing: border-box; }
            thead th { background: #e0e0e0 !important; color: #000 !important; }
    ...
    parties.forEach(party => {
        ...
        html += `
            <tr>
                ...
                <td>
                    <button class="action-btn view-btn-small" onclick="viewPartyLedgerDirectly('${party.id}')" title="View Full Ledger" style="background-color: #667eea; color: white; border: none;">
...
function viewPartyLedgerDirectly(partyId) {
    // Close the party modal
    closePartyModal();
    // Open reports modal
    showReportsModal();
    // Switch to Party Ledger tab
    showReportTab('party');
    // Set a slight timeout to ensure DOM updates and select populates
    setTimeout(() => {
        const select = document.getElementById('partyReportSelect');
        if (select) {
